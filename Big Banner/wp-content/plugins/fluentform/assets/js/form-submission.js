        ...
        window.fluentFormrecaptchaSuccessCallback = function(e) {
            ...
            function(e, t) {
                ...
                window.fluentFormApp = function(r) {
                    ...
                    if (n[a]) return n[a];
                    var f, s, c, l, u, d, h, p, m, g, v, _, y, w, b, k, C, x, j, S, O, F, T = o.form_id_selector,
                        A = "." + a;
                    return f = i, s = {}, c = function() {
                        ...
                        try {
                            ...
                            if (t.each(e.find("[type=file]"), (function(e, r) {
                                ...
                                return t(A + "_errors").html(f.append(l, c)).show()
                            }
                        ...
                        if (!this.isSending) {
                            ...
                            this.isSending = !0, t.post(f, n).then((function(n) {
                                ...
                                if (n.data.append_data && O(n.data.append_data), n.data.nextAction) r.trigger("fluentform_next_action_" + n.data.nextAction, {
                                    form: r,
                                    response: n
                                });
                                else {
                                ...
                                if (r.trigger("fluentform_submission_failed", {
                                    ...
                                    if (t.responseJSON.append_data && O(t.responseJSON.append_data), b(t.responseJSON.errors), _(350), r.find(".fluentform-step").length) {
                                ...
                                if (s.isSending = !1, m(r), window.grecaptcha) {
                                    var t = r.find(".ff-el-recaptcha.g-recaptcha").data("grecaptcha_widget_id");
                                    t && grecaptcha.reset(t)
                                }
                                if (window.hcaptcha) {
                                    var n = r.find(".ff-el-hcaptcha.h-captcha").data("hcaptcha_widget_id");
                                    n && hcaptcha.reset(n)
                                }
                                if (window.turnstile) {
                                    var a = r.find(".ff-el-turnstile.cf-turnstile").data("turnstile_widget_id");
                                    a && turnstile.reset(a)
                                }
                            }))
                        }
                        ...
                        if (r.find(".ff-el-hcaptcha.h-captcha").length) {
                            var o = r.find(".ff-el-hcaptcha.h-captcha"),
                                f = o.data("sitekey"),
                                s = o.attr("id"),
                                c = hcaptcha.render(document.getElementById(s), {
                                    sitekey: f
                                });
                            o.attr("data-hcaptcha_widget_id", c)
                        }
                    }, O = function(e) {
                        ...
                        initFormHandlers: function() {
                            g(), l(), x(), r.removeClass("ff-form-loading").addClass("ff-form-loaded"), r.on("show_element_error", (function(e, t) {
                        ...
                        initTriggers: function() {
                            r = c(), jQuery(document.body).trigger("fluentform_init", [r, o]), jQuery(document.body).trigger("fluentform_init_" + o.id, [r, o]), r.trigger("fluentform_init_single", [this, o]), r.find("input.ff-el-form-control").on("keypress", (function(e) {
                                ...
                                var o = t(this).offset().left,
                                    ...
                                    s = a.outerHeight(),
                                    c = o - f / 2 + 10;
                                c < 15 && (c = 15), a.css("top", t(this).offset().top - s - 5), a.css("left", c)
